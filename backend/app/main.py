...
app.include_router(analytics_router, prefix=settings.API_V1_STR, dependencies=protected_dependencies)
...
app.include_router(reports_router, prefix=settings.API_V1_STR, dependencies=protected_dependencies)
